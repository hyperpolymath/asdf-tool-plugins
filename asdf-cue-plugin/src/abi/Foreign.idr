...
module CUE.ABI.Foreign

import CUE.ABI.Types
import CUE.ABI.Layout
...
||| Free C string
export
%foreign "C:cue_free_string, libcue"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:cue_get_string, libcue"
...
||| Process array data
export
%foreign "C:cue_process_array, libcue"
...
export
%foreign "C:cue_last_error, libcue"
...
export
%foreign "C:cue_build_info, libcue"
...
||| Register a callback
export
%foreign "C:cue_register_callback, libcue"
...
export
%foreign "C:cue_is_initialized, libcue"
