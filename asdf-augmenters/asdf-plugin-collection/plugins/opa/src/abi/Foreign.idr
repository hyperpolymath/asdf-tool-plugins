...
module OPA.ABI.Foreign

import OPA.ABI.Types
import OPA.ABI.Layout
...
||| Free C string
export
%foreign "C:opa_free_string, libopa"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:opa_get_string, libopa"
...
||| Process array data
export
%foreign "C:opa_process_array, libopa"
...
export
%foreign "C:opa_last_error, libopa"
...
export
%foreign "C:opa_build_info, libopa"
...
||| Register a callback
export
%foreign "C:opa_register_callback, libopa"
...
export
%foreign "C:opa_is_initialized, libopa"
