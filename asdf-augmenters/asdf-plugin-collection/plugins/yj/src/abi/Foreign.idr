...
module YJ.ABI.Foreign

import YJ.ABI.Types
import YJ.ABI.Layout
...
||| Free C string
export
%foreign "C:yj_free_string, libyj"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:yj_get_string, libyj"
...
||| Process array data
export
%foreign "C:yj_process_array, libyj"
...
||| Register a callback
export
%foreign "C:yj_register_callback, libyj"
...
export
%foreign "C:yj_is_initialized, libyj"
