...
module AGE.ABI.Foreign

import AGE.ABI.Types
import AGE.ABI.Layout
...
||| Free C string
export
%foreign "C:age_free_string, libage"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:age_get_string, libage"
...
||| Process array data
export
%foreign "C:age_process_array, libage"
...
export
%foreign "C:age_last_error, libage"
...
export
%foreign "C:age_build_info, libage"
...
||| Register a callback
export
%foreign "C:age_register_callback, libage"
...
export
%foreign "C:age_is_initialized, libage"
