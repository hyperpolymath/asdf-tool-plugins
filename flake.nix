{
  description = "asdf-tool-plugins - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 asdf-tool-plugins development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P asdf-tool-plugins.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/asdf-tool-plugins $out/bin/  # Rust
            # cp bin/asdf-tool-plugins $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/asdf-tool-plugins";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-asdf-tool-plugins" {
