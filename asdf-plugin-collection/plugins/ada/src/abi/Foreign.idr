...
module ADA.ABI.Foreign

import ADA.ABI.Types
import ADA.ABI.Layout
...
||| Free C string
export
%foreign "C:ada_free_string, libada"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:ada_get_string, libada"
...
||| Process array data
export
%foreign "C:ada_process_array, libada"
...
export
%foreign "C:ada_last_error, libada"
...
export
%foreign "C:ada_build_info, libada"
...
||| Register a callback
export
%foreign "C:ada_register_callback, libada"
...
export
%foreign "C:ada_is_initialized, libada"
