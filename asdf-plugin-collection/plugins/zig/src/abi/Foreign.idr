...
module ZIG.ABI.Foreign

import ZIG.ABI.Types
import ZIG.ABI.Layout
...
||| Free C string
export
%foreign "C:zig_free_string, libzig"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:zig_get_string, libzig"
...
||| Process array data
export
%foreign "C:zig_process_array, libzig"
...
export
%foreign "C:zig_last_error, libzig"
...
export
%foreign "C:zig_build_info, libzig"
...
||| Register a callback
export
%foreign "C:zig_register_callback, libzig"
...
export
%foreign "C:zig_is_initialized, libzig"
