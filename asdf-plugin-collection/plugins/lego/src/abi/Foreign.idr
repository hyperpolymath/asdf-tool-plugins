...
module LEGO.ABI.Foreign

import LEGO.ABI.Types
import LEGO.ABI.Layout
...
export
%foreign "C:lego_process, liblego"
...
||| Free C string
export
%foreign "C:lego_free_string, liblego"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:lego_get_string, liblego"
...
||| Process array data
export
%foreign "C:lego_process_array, liblego"
...
export
%foreign "C:lego_last_error, liblego"
...
||| Get library version
export
%foreign "C:lego_version, liblego"
...
export
%foreign "C:lego_build_info, liblego"
...
||| Register a callback
export
%foreign "C:lego_register_callback, liblego"
...
export
%foreign "C:lego_is_initialized, liblego"
