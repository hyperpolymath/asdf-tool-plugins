...
module UI.ABI.Foreign

import UI.ABI.Types
import UI.ABI.Layout
...
||| Free C string
export
%foreign "C:ui_free_string, libui"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:ui_get_string, libui"
...
||| Process array data
export
%foreign "C:ui_process_array, libui"
...
||| Register a callback
export
%foreign "C:ui_register_callback, libui"
...
export
%foreign "C:ui_is_initialized, libui"
