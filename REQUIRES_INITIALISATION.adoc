...
*This repository is not finished being set up.* 19 substitution token(s)
across 15 file(s) still have no value.
...
Full fingerprint of the security-contact PGP key. NOTE: no key is
published anywhere in this estate — if none is held, delete the PGP
